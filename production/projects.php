                    ...
                    <table class="table table-striped projects">
                      <thead>
                        <tr>
                          ...
                          <!-- <th>Status</th> -->
                          <th style="width: 20%">#Select Your Project</th>
                        </tr>
                      </thead>
                      <tbody>
                          ...
                          <?php
                            ...
                            $query = "SELECT projects.proj_id, projects.proj_name, projects.proj_progress from projects";
                            ...
                            foreach ($data as $row) {
                              ...
                              <td>
                                <a href="success.php?id='. $row['proj_id']. '"class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Select </a>
