                ...
                foreach ($data as $row) {
                  echo '<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                      ...
                      <h3>Testers</h3>
                      <p>' . $row["count(*)"] . ' testers are in the network now </p>
                    </div>
                  </div>';
                }
                ?>
                ...
                foreach ($data as $row) {
                  echo '<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                      ...
                      <div class="count">'. $row["count(*)"] . '</div>
                      <h3>Projects</h3>
                      <p>' . $row["count(*)"] . ' projects are in the network now </p>
                    </div>
                  </div>';
                }
                ?>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                      <div>
                        ...
                        <?php
                          require_once("config.php");
                          $conn = getPDOConnection();
                          $query = "SELECT * from projects ORDER BY proj_progress desc";
                          $data = $conn -> query($query);
                          $data->setFetchMode(PDO::FETCH_ASSOC);
                          ...
                          foreach ($data as $row) {
                            echo '
                              <li class="media event">
                                <div class="media-body">
                                  <a class="title" href="#">'. $row["proj_name"] . '</a>
                                  <p><strong>'. $row["proj_tool"] . '</strong></p>
                                  <p> <small>'. $row["proj_progress"] . '</small>
                                  </p>
                                </div>
                              </li>';
                          }
